...
<?php
	...
	$nama = $_GET['NAMA_WISATA']; //get the no which will deleted
	//var_dump($nama);
	//query for update data in database
    $tampil = "SELECT NAMA_WISATA, TANGGAL_WISATA, WAKTU_WISATA, ISI_WISATA, GAMBAR_WISATA 
	FROM wisata_pemancingan where JUDUL_WISATA = '$nama'"; 
	...
	<tr>
			 ...
			 <div class="span5">
			 <tr>
				<td><th>Judul Wisata Pemancingan     : </th> <td><?php echo $data[0]?></td>
			</tr>
			</br>
			<br>
			...
			<br>
				<td><th>Deskripsi lomba : </th> <td><?php echo $data[5]?></td>
			</tr>
			</br>
			<p><a href="bookingwisata.html?JUDUL_WISATA=<?php echo $data[0];?>" class="btn btn-danger">Booking Wisata</a></p>
			 <br></br>
			 <br></br>
	<?php
	 $no++; ?>  </div></div><?php
