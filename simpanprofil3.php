...
$inputjawaban2=$_POST['inputJawaban2'];
 ...
 VALUES('', '$inputnamadepan','$inputnamabelakang', '$inputjeniskelamin', '$inputtanggalLahir', '$inputemail', '$inputpassword', '$inputgambar', '$inputpertanyaan1', '$inputjawaban1', '$inputpertanyaan2', '$inputjawaban2')";
