...
<?php
    ...
    $tampil = "SELECT JUDUL_PERLOMBAAN, TANGGAL_LOMBA, WAKTU_LOMBA, TEMPAT_LOMBA, GAMBAR_LOMBA, ISI_PERLOMBAAN FROM perlombaan where JUDUL_PERLOMBAAN = '$nama'"; 
	...
	<tr>
			...
			<p><a href="bookinglomba.html?JUDUL_PERLOMBAAN=<?php echo $data[0];?>" class="btn btn-danger">Booking Lomba</a></p>
			 <br></br>
			 <br></br>
	<?php
	 $no++; ?>  </div></div><?php
