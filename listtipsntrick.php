...
<div class="row-fluid">
  ...
  if(isset($_GET['halaman'])) {
	...
	$batas=$batas+1;
    $tampil = "SELECT JUDUL_TIPSTRIK, ISI_TIPSTRIK, GAMBAR_TIPS FROM tips_trik LIMIT $posisi, $batas";
    ...
    $tampil2 = mysql_query("SELECT JUDUL_TIPSTRIK, ISI_TIPSTRIK, GAMBAR_TIPS FROM tips_trik ");
